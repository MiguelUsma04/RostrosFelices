    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeInvoice", x => new { x.EmployeesId, x.InvoicesId });
                    table.ForeignKey(
                        name: "FK_EmployeeInvoice_Employees_EmployeesId",
                        column: x => x.EmployeesId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeInvoice_Invoices_InvoicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeInvoice_InvoicesId",
                table: "EmployeeInvoice",
                column: "InvoicesId");
